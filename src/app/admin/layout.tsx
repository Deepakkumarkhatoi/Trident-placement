...
import { BarChart3, Users, Briefcase, ClipboardList, Settings, LogOut } from 'lucide-react';
...
const menuItems = [
  ...
  { title: 'Drives',       icon: Briefcase,      href: '/admin/drives' },
  { title: 'Applications', icon: ClipboardList,  href: '/admin/applications' },
        ...
        <div className="flex-1 overflow-y-auto py-4">
          <SidebarMenu>
            {menuItems.map((item) => {
              ...
              // Fix: /admin uses strict equality so it doesn't match all sub-routes
              const isActive =
                item.href === '/admin'
                  ? pathname === '/admin'
