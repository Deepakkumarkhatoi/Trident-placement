...
const notifications = [
  { id: 1, type: "success" as NotifType, title: "Shortlisted at TechCorp Solutions", desc: "You've been shortlisted for the Technical Interview round.", time: "2 hours ago", unread: true },
  { id: 2, type: "drive" as NotifType, title: "New Drive: NexGen Solutions", desc: "DevOps Engineer position open. Package: 10 LPA. Apply before 02-04-25.", time: "5 hours ago", unread: true },
  { id: 3, type: "event" as NotifType, title: "Pre-Placement Talk — InnoTech Labs", desc: "Scheduled for March 5, 2026 at 10:00 AM in Seminar Hall B.", time: "1 day ago", unread: true },
